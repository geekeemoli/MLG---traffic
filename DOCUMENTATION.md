...
```
MLG---traffic/
├── README.md                    # Project introduction and progress
...
```bash
pip install networkx osmnx pandas numpy torch torch_geometric scipy matplotlib shapely tqdm
```
...
- **Citation:** Boeing, G. (2025). Modeling and Analyzing Urban Networks and Amenities with OSMnx. Geographical Analysis 57 (4), 567-577. doi:10.1111/gean.70009
...
- **Citation:** Facebook Connectivity Lab and Center for International Earth Science Information Network - CIESIN - Columbia University. 2016. High Resolution Settlement Layer (HRSL). Source imagery for HRSL Copyright 2016 DigitalGlobe. Accessed 19.12.2025. Data shared under: Creative Commons Attribution International.
...
- **Citation:** Loder, A., Ambühl, L., Menendez, M. et al. Understanding traffic capacity of urban networks. Sci Rep 9, 16283 (2019). https://doi.org/10.1038/s41598-019-51539-5
- **Files:**
